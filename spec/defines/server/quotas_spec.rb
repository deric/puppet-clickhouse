...
"
        is_expected.to contain_file('/etc/clickhouse-server/conf.d/quotas.xml').with_content(quotas_defaults)
      end
...
"
        ...
        is_expected.to contain_file('/etc/clickhouse-server/conf.d/quotas.xml').with_content(quotas_set)
      end
    end
  end
end
